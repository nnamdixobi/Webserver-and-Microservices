...
public class UserValidService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // server is listening on port 5250
    ...
    private static void serve(Socket socket, int clientID) throws Exception {
        ...
        boolean output = adapter.checkValidUser(msgData.string1, msgData.string2);;
        Gson gson = new Gson();
        String ans = "";
    ...
    private static boolean register(String regHost, int regPort, String myHost, int myPort) throws IOException {
        ...
        info.serviceCode = ServiceInfoModel.USER_VALID_SERVICE;
